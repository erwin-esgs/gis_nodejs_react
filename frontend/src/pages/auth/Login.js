...
import Kresna from '../../assets/kresna.png';
        ...
        <Container maxWidth="sm">
          <ContentStyle>
            <Stack direction="row" alignItems="center" sx={{ mb: 5 }}>
              ...
              <Box sx={{ flexGrow: 1, fontWeight: 'bold', textTransform: 'uppercase',  }}>
                <div style={{fontSize: 36, fontStyle: "italic"}}>E - OFFICE</div>
                <div style={{fontSize: 26}}>DIT INTELKAM </div>
                {/* <Typography variant="h3" gutterBottom>
                  ATTENDANCE 
                </Typography> */}
                <Typography sx={{ color: 'text.secondary' }}>POLDA SULTENG</Typography>
              </Box>
            </Stack>
